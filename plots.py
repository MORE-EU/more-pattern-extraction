...
def plot_knee(mps, save_plot=False, filename='knee.png'):
    ...
    """ 
    Plot the minimum value of the matrix profile for each dimension. This plot is used to visually look for
    a 'knee' or 'elbow' that can be used to find the optimal number of dimensions to use.
...
def plot_profile(df, mp, col_name): 
    """
    Plot the 'Column_name' graph and the corresponding MatrixProfile.
    We denote with the black arrow to top motif in our set
